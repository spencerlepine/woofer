...
const removeUserFromMatchQueue = ({
  DATA_KEYS,
  models: { MatchQueue },
  handleErrorResponse
}) => (res, thisUserId, thatUserId) => {
  if (res === undefined || thisUserId === undefined || thatUserId  === undefined) {
    const err = 'removeUserFromMatchQueue called with invalid arguments'
...
module.exports = removeUserFromMatchQueue(controllerHelpers)
