...
export const testContextExports = (ContextProdiver, useContext, expectedExports) => {
  ...
  it('should render ContextProdiver with no errors', () => {
    expect(() => customRender(<ContextProdiver><p>MOCK CHILD</p></ContextProdiver>)).not.toThrow(new Error);
  });

  it('should render the children', () => {
    customRender(<ContextProdiver><p data-testid="mockChild">MOCK CHILD</p></ContextProdiver>);
  ...
  test('passes correct values to children', () => {
    ...
    customRender(<ContextProdiver><MockChild /></ContextProdiver>);
  });
};
